...
if (calendarDays) {
    ...
    for (let i = 0; i < 6; i++) {
        ...
        // Instead of disabling days, attach an event listener to all days.
        dayElement.addEventListener('click', function () {
            ...
            // Calculate the corresponding date in the previous week by subtracting 7 days
            const selectedDate = new Date(date);
            selectedDate.setDate(selectedDate.getDate() - 7);

            // Display data for the corresponding day of the previous week
    ...
    // Optionally, select today's day by default (adjusted to last week's equivalent)
