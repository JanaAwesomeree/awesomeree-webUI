// API configuration
// API configuration - use a dynamic date query
function getApiEndpointForDate(date) {
    const formattedDate = date.toISOString().split('T')[0]; // Get YYYY-MM-DD format
    return `https://t9x8zj0h-8000.asse.devtunnels.ms/shopee-health/daily-metrics/?date=${formattedDate}`;
}
